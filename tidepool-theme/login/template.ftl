...
<#assign attemptedUsernameHiddenPages = ["login-username", "trusted-device-register", "login-otp", "select-authenticator", "login-recovery-authn-code-input", "login-recovery-authn-code-config", "update-email", "login-update-password", "hidpd-select-idp"]>
