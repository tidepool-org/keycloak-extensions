      ...
      <tr>
        <td class="one-column" style="padding:0;">
          <table width="100%" style="border-spacing:0;color:#333333;">
              ...
              <tr>
                <td class="inner centered" style="padding:0;padding:10px;text-align:center;">
                  ...
                  <![endif]-->
                        ...
                        <a class="btn primary" href='<#nested "actionLink">' style="color:#627CFF;text-decoration:none;border-radius:4px;font-size:14px;font-weight:bold;padding:10px 20px;display:inline-block;background-color:#627CFF;color:#FFFFFF;Margin-left:5px;Margin-right:5px;Margin-bottom:10px;">
                          <#nested "actionText">
                        </a>
            ...
            <tr>
              <td class="inner centered" style="padding:0;padding:10px;text-align:center;">
                <a href="${properties.tidepoolUrl!}" style="color:#627CFF;text-decoration:none;"><img class="logo" width="220" height="24" src="${properties.tidepoolAssetsUrl!}/img/tidepool_logo_light_x2.png" alt="Tidepool logo" style="border:0;display:inline-block;Margin-bottom:36px;max-width:220px;height:auto;"/></a>
              </td>
            </tr>
            <tr>
              <td class="inner centered" style="padding:0;padding:10px;text-align:center;">
                  ...
                  <tr>
                    <td class="no-left-padding" valign="middle" style="padding:0;padding:0 8px;padding-left:0;">
                      <a href="https://www.twitter.com/Tidepool_org" style="color:#627CFF;text-decoration:none;">
                        <img width="32" height="24" src="${properties.tidepoolAssetsUrl!}/img/twitter_white_x2.png" alt="Twitter logo" style="border:0;"/>
                      </a>
                    </td>
                    <td valign="middle" style="padding:0;padding:0 8px;">
                      <a href="http://www.facebook.com/TidepoolOrg" style="color:#627CFF;text-decoration:none;">
                        <img width="14" height="24" src="${properties.tidepoolAssetsUrl!}/img/facebook_white_x2.png" alt="Facebook logo" style="border:0;"/>
                      </a>
                    </td>
                    ...
                    <td class="no-right-padding" valign="middle" style="padding:0;padding:0 8px;padding-right:0;">
                      <a href="http://www.jdrf.org/" style="color:#627CFF;text-decoration:none;">
                        <img width="94" height="24" src="${properties.tidepoolAssetsUrl!}/img/jdrf_logo_reverse_x2.png" alt="JDRF logo" style="border:0;"/>
                      </a>
                    </td>
                  </tr>
                </table>
                  ...
                  <tr>
                    ...
                    <td valign="top" style="padding:0;padding:0 2px;">
                      <a href="https://itunes.apple.com/us/app/blip-notes/id1026395200?mt=8" style="color:#627CFF;text-decoration:none;">
                        <img width="81" height="24" src="${properties.tidepoolAssetsUrl!}/img/app_store_badge_x2.png" alt="App Store badge" style="border:0;"/>
                      </a>
                    </td>
                    <td class="no-right-padding" valign="top" style="padding:0;padding:0 2px;padding-right:0;">
                      <a href="https://play.google.com/store/apps/details?id=io.tidepool.urchin&hl=en" style="color:#627CFF;text-decoration:none;">
                        <img width="72" height="24" src="${properties.tidepoolAssetsUrl!}/img/google_play_badge_x2.png" alt="Google Play badge" style="border:0;"/>
                      </a>
                    </td>
                  </tr>
                </table>
