...
RUN unset MAVEN_CONFIG && \
    ...
    wget -O keycloak-home-idp-discovery.jar https://github.com/sventorben/keycloak-home-idp-discovery/releases/download/v25.0.0/keycloak-home-idp-discovery.jar
