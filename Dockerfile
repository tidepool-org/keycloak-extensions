...
RUN unset MAVEN_CONFIG && \
    ...
    wget -O keycloak-home-idp-discovery.jar https://github.com/tidepool-org/keycloak-home-idp-discovery/releases/download/v26.6.0/keycloak-home-idp-discovery.jar
