...
RUN unset MAVEN_CONFIG && \
    ...
    wget -O keycloak-home-idp-discovery.jar https://github.com/tidepool-org/keycloak-home-idp-discovery/releases/download/v21.3.2/keycloak-home-idp-discovery.jar
