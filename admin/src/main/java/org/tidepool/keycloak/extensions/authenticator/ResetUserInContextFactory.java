...
public final class ResetUserInContextFactory implements AuthenticatorFactory, ServerInfoAwareProviderFactory {
    ...
    public String getHelpText() {
        return "Resets the user currently in the authentication context";
    }
